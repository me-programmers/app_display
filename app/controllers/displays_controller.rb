class DisplaysController < ApplicationController
	...
	def theme5
		...
		@geteceranpg5 = MarketComparison.select("komoditi, eceran, jenis").where("eceran > 0 and jenis ='Holtikultura'").limit(5)
		...
		@getgrosir2pg4 = MarketComparison.select("komoditi, grosir2, jenis").where("grosir2 > 0 and jenis='Holtikultura'").limit(5)
